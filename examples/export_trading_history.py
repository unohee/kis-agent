    ...
    try:
        ...
        if not samsung_df.empty:
            ...
            if 'sll_buy_dvsn_cd_name' in samsung_df.columns:
                buy_count = samsung_df[samsung_df['sll_buy_dvsn_cd_name'].str.contains('매수', na=False)].shape[0]
                sell_count = samsung_df[samsung_df['sll_buy_dvsn_cd_name'].str.contains('매도', na=False)].shape[0]
