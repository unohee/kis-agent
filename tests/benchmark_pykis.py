...
def main():
    ...
    # 병렬 처리 테스트 (5 workers)
    par5_time, par5_speed = benchmark_parallel(agent, test_codes, iterations=2, workers=5)
    ...
    par10_time, par10_speed = benchmark_parallel(agent, test_codes, iterations=2, workers=10)
