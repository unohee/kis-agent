...
수정일: 2026-02-06 - API 시그니처 변경 반영 (market 파라미터 추가)
"""
...
class TestStockAPIFacade(unittest.TestCase):
    ...
    def test_get_stock_price_delegation(self):
        ...
        # market 파라미터 기본값 "J" 포함
        self.api.price_api.get_stock_price.assert_called_once_with("005930", "J")
    ...
    def test_get_orderbook_delegation(self):
        ...
        self.assertEqual(result, expected_result)
        self.api.price_api.get_orderbook.assert_called_once_with("005930", "J")
    ...
    def test_get_orderbook_raw_delegation(self):
        ...
        self.assertEqual(result, expected_result)
        self.api.price_api.get_orderbook_raw.assert_called_once_with("005930", "J")
    ...
    def test_get_market_fluctuation_delegation(self):
        ...
        self.assertEqual(result, expected_result)
        self.api.market_api.get_market_fluctuation.assert_called_once_with("J")
    ...
    def test_get_market_rankings_delegation(self):
        ...
        self.assertEqual(result, expected_result)
        self.api.market_api.get_market_rankings.assert_called_once_with(10000000, "J")
    ...
    def test_get_market_rankings_default_volume(self):
        ...
        self.assertEqual(result, expected_result)
        self.api.market_api.get_market_rankings.assert_called_once_with(5000000, "J")
    ...
    def test_get_volume_power_delegation(self):
        ...
        self.assertEqual(result, expected_result)
        self.api.market_api.get_volume_power.assert_called_once_with(1000000, "J")
    ...
    def test_get_volume_power_default_volume(self):
        ...
        self.assertEqual(result, expected_result)
        self.api.market_api.get_volume_power.assert_called_once_with(0, "J")
    ...
    def test_get_stock_info_delegation(self):
        ...
        self.assertEqual(result, expected_result)
        self.api.market_api.get_stock_info.assert_called_once_with("005930", "J")
    ...
    def test_get_stock_member_delegation(self):
        ...
        self.assertEqual(result, expected_result)
        self.api.investor_api.get_stock_member.assert_called_once_with("005930", 5, "J")
    ...
    def test_get_stock_member_default_retries(self):
        ...
        self.assertEqual(result, expected_result)
        self.api.investor_api.get_stock_member.assert_called_once_with(
            "005930", 10, "J"
        )
    ...
    def test_inquire_daily_itemchartprice_delegation(self):
        ...
        self.api.price_api.inquire_daily_itemchartprice.assert_called_once_with(
            "005930", "20231201", "20231215", "D", "1", "J"
        )
