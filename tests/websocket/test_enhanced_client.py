...
class TestDataHandlers:
    ...
    def test_handle_trade_data_valid(self, client):
        ...
        raw_data = [
            '005930', '093000', '75000', '1000', '+500', '+1.23', '1', '7500000',
            '75100', '74900', '75500', '1000000', '100', '7500000', '7500000',
            '1', '2', '3', '102.5', '1'
        ]
        metadata = {'name': '삼성전자'}
...
class TestAsyncOperations:
    ...
    async def test_init_subscriptions(self, client):
        """비동기 초기화 테스트"""
        with patch.object(client, 'ws_agent') as mock_agent, \
             patch.object(client.stock_api, 'get_stock_info') as mock_get_info:
...
class TestIntegration:
    ...
    def client_with_mocks(self, mock_kis_client, account_info):
        """완전히 모킹된 클라이언트"""
        with patch('pykis.websocket.enhanced_client.StockAPI') as mock_stock_api, \
             patch('pykis.websocket.enhanced_client.WSAgent') as mock_ws_agent:
