...
from pykis.websocket.ws_agent import WSAgent, SubscriptionType
...
async def run_mock_test() -> bool:
    ...
    try:
        ...
        STOCK_CODES = [
            ...
            "003670", "012330", "066570", "032830", "096770",
            "003550", "034730", "015760", "017670", "030200",
            "033780", "010130", "009150", "000270", "005380",
            "018260", "034020", "010950", "086790", "024110",
            "316140", "009540", "010140", "011200", "036570",
            "259960", "352820", "003490", "000720", "005490",
            "000100",  # 41번째 코드 (임의)
        ]
